...
state_code_3=$9
this_dir=$(pwd)
shp_download_dir=$this_dir/input/geofiles/$country_code/$state_code/
shp_download_dir_2=$this_dir/input/geofiles/$country_code_2/$state_code_2/
shp_download_dir_3=$this_dir/input/geofiles/$country_code_3/$state_code_3/
